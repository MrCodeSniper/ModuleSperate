...
import com.mujirenben.android.poplayer.interfaces.HybirdManager;
import com.mujirenben.android.poplayer.interfaces.LayerLifecycle;
import com.mujirenben.android.poplayer.interfaces.NavigationManager;
import com.mujirenben.android.poplayer.interfaces.PushManager;
import com.mujirenben.android.poplayer.interfaces.TimerManager;
 ...
 * 装配能力接口
 */
public class HrzLayerController implements LayerLifecycle {
...
//    }
    ...
    public HrzLayerController(Builder builder){//私有化构造
       initialize(builder);
       onCreate();
   }
    ...
    public static HrzLayerController.Builder builder(){
        return new Builder();
    }
    ...
    public static class Builder {
        ...
        public HrzLayerController.Builder setTimerManagerImpl(TimerManagerImpl timerManagerImpls) {
            this.timerManagerImpl = timerManagerImpls;
            return this;
        }

        public HrzLayerController.Builder setPushManagerImpl(PushManagerImpl pushManagerImpls) {
            this.pushManagerImpl = pushManagerImpls;
            return this;
        }

        public HrzLayerController.Builder setWebViewConfigImpl(WebViewConfig webviewImpls) {
            this.webViewConfigImpl = webviewImpls;
            return this;
        }

        public HrzLayerController build(){
            return new HrzLayerController(this);
        }
