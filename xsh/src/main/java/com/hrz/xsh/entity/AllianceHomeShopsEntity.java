package com.hrz.xsh.entity;

import java.util.List;

public class AllianceHomeShopsEntity extends BaseEntity {


    @Override
    public String toString() {
        return "AllianceHomeShopsEntity{" +
                "data=" + data +
                '}';
    }
    ...
    public static class DataBean {
        ...
        private List<ShopBean>    accordList;
        private List<ShopBean>    otherList;


        public List<ShopBean> getAccordList() {
            return accordList;
        }

        public void setAccordList(List<ShopBean> accordList) {
            this.accordList = accordList;
        }

        public List<ShopBean> getOtherList() {
            return otherList;
        }

        public void setOtherList(List<ShopBean> otherList) {
