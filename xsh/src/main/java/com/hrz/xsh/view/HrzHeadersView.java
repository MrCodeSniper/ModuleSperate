 ...
 */
public class HrzHeadersView extends PtrFrameLayout implements PtrUIHandler {
...
//    private AnimationDrawable drawable;
    ...
    public HrzHeadersView(Context context) {
        super(context);
        initView();
    }

    public HrzHeadersView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public HrzHeadersView(Context context, AttributeSet attrs, int defStyle) {
