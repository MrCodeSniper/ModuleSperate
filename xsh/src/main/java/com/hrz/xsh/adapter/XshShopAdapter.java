...
import com.hrz.xsh.utils.DateUtil;
import com.hrz.xsh.utils.EmptyUtils;
...
public class XshShopAdapter extends BaseQuickAdapter<AllianceHomeShopsEntity.ShopBean, BaseViewHolder> {


    public XshShopAdapter(int layoutResId) {
        super(layoutResId);
    }
